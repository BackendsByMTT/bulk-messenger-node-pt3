const addMessage =
  "INSERT INTO messages (sent_to, message, agent) VALUES($1, $2, $3) RETURNING sent_to, message, status";

const createMessageTable =
  "CREATE TABLE messages ( id SERIAL PRIMARY KEY, sent_to VARCHAR(255) NOT NULL, message TEXT NOT NULL, status VARCHAR(20) NOT NULL DEFAULT 'pending', agent VARCHAR(255) NOT NULL, created_at TIMESTAMP NOT NULL DEFAULT CURRENT_TIMESTAMP);";
